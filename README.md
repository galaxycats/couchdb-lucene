...
<pre>
http://localhost:5984/database/_fti/_design/myddoc/by_subject?q=hello
http://localhost:5984/database/_fti/_design/myddoc/by_content?q=hello
</pre>
...
<pre>
http://localhost:5984/dbname/_fti/_design/myddoc/view_name?q=field_name:value
http://localhost:5984/dbname/_fti/_design/myddoc/view_name?q=field_name:value&sort=other_field
http://localhost:5984/dbname/_fti/_design/myddoc/view_name?debug=true&sort=billing_size&q=body:document AND customer:[A TO C]
</pre>
...
<pre>
http://127.0.0.1:5984/&lt;db>/_fti/_design/myddoc/view
</pre>
...
<pre>
curl -X POST http://localhost:5984/&lt;db>/_fti/_design/&lt;ddoc>/&lt;index>/_optimize
</pre>

If you just want to expunge pending deletes, then call;

<pre>
curl -X POST http://localhost:5984/&lt;db>/_fti/_design/&lt;ddoc>/&lt;index>/_expunge
</pre>
